...
RSpec.describe WallsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested wall as @wall" do
      wall = Wall.create! valid_attributes
      get :show, params: {id: wall.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested wall as @wall" do
      wall = Wall.create! valid_attributes
      get :edit, params: {id: wall.to_param}, session: valid_session
      expect(assigns(:wall)).to eq(wall)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Wall" do
        expect {
          post :create, params: {wall: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved wall as @wall" do
        post :create, params: {wall: invalid_attributes}, session: valid_session
        expect(assigns(:wall)).to be_a_new(Wall)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested wall" do
        wall = Wall.create! valid_attributes
        put :update, params: {id: wall.to_param, wall: new_attributes}, session: valid_session
        wall.reload
      ...
      it "assigns the requested wall as @wall" do
        wall = Wall.create! valid_attributes
        put :update, params: {id: wall.to_param, wall: valid_attributes}, session: valid_session
        expect(assigns(:wall)).to eq(wall)
      end
    ...
    context "with invalid params" do
      it "assigns the wall as @wall" do
        wall = Wall.create! valid_attributes
        put :update, params: {id: wall.to_param, wall: invalid_attributes}, session: valid_session
        expect(assigns(:wall)).to eq(wall)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested wall" do
      wall = Wall.create! valid_attributes
      expect {
        delete :destroy, params: {id: wall.to_param}, session: valid_session
      }.to change(Wall, :count).by(-1)
    end
